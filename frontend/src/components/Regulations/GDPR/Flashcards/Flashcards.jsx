...
import flashcardsData from "./data/gdpr_flashcards.json";
...
const Flashcards = () => {
    ...
    const loadAssessment = async () => {
      ...
      try {
        ...
        const response = await fetch(
          `http://localhost:3001/api/regulation-assessments/user/${user.uid}/gdpr`
        );
        ...
        console.log('✅ GDPR assessment loaded:', assessment);
        ...
        console.error('Error loading GDPR assessment:', err);
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      console.log('✅ GDPR assessment submitted successfully:', data);
      
      setProcessingStep(3);
      await new Promise(resolve => setTimeout(resolve, 600));
      
      navigate(`/dashboard/gdpr/results/${assessmentId}`);
    } catch (e) {
    ...
    return (
      <div className="flashcards-container">
        <div className="loading-screen">
          ...
          <p>Loading your GDPR assessment...</p>
        </div>
      </div>
    );
  }
  ...
  if (processing) {
    const steps = [
      { title: 'Analyzing your data protection responses...', icon: '🔍' },
  ...
  return (
    <div className="flashcards-container">
      <div className="flashcard-header">
        ...
        <p>Answer these questions to help us understand your company's data protection practices and generate your compliance report.</p>
