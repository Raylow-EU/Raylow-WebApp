...
const Flashcards = () => {
    ...
    const loadAssessment = async () => {
      ...
      try {
        ...
        const response = await fetch(
          `http://localhost:3001/api/regulation-assessments/user/${user.uid}/ai-act`
        );
        ...
        console.log('✅ AI Act assessment loaded:', assessment);
        ...
        console.error('Error loading AI Act assessment:', err);
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Step 2: Generating recommendations (actual API call)
      const response = await fetch(
      ...
      console.log('✅ AI Act assessment submitted successfully:', data);
      ...
      navigate(`/dashboard/ai-act/results/${assessmentId}`);
    } catch (e) {
    ...
    return (
      <div className="flashcards-container">
        <div className="loading-screen">
          ...
          <p>Loading your AI Act assessment...</p>
        </div>
      </div>
    );
  }

  // Processing overlay during AI analysis
  if (processing) {
    const steps = [
      { title: 'Analyzing your AI system responses...', icon: '🔍' },
        ...
        <div className="processing-modal">
          ...
          <div className="processing-progress">
            {steps.map((step, index) => (
              <div 
                key={index} 
                className={`progress-dot ${index + 1 <= processingStep ? 'active' : ''}`}
  ...
  return (
    <div className="flashcards-container">
      <div className="flashcard-header">
        <h1>AI Act Compliance Assessment</h1>
        <p>Answer these questions to help us understand your company's AI systems and generate your compliance report.</p>
